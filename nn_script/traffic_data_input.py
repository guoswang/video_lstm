...
class DataInput(DataInputAbs):
    ...
    def get_arg_dict(self, model_params):
        ...
        arg_dict_list += [arg_dict["feature"]] * unroll_num
        arg_dict_list += [arg_dict["label"]] * unroll_num
        arg_dict_list += [arg_dict["mask"]] * unroll_num
    ...
    def load_data(self, model_params, arg_dict):
        ...
        unroll_num = model_params["unroll_num"]
        tensor_list = [input_class] * unroll_num + \
                    [label_class] * unroll_num + \
                    [mask_class] * unroll_num
        ...
        self.input = batch_tensor_list[0 : unroll_num]
        self.label = batch_tensor_list[1 * unroll_num : 2 * unroll_num]
        self.mask = batch_tensor_list[2 * unroll_num : -1]
        self.file_line = batch_tensor_list[-1]
